...
CREATE TABLE `c1` (
  ...
  PRIMARY KEY (`id`),
  KEY `c1_saksi_id_foreign` (`saksi_id`),
  CONSTRAINT `c1_saksi_id_foreign` FOREIGN KEY (`saksi_id`) REFERENCES `saksi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `kecamatan` (
  ...
  PRIMARY KEY (`id`),
  KEY `kecamatan_user_id_foreign` (`user_id`),
  KEY `kecamatan_kab_id_foreign` (`kab_id`),
  CONSTRAINT `kecamatan_kab_id_foreign` FOREIGN KEY (`kab_id`) REFERENCES `kabupaten` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `kecamatan_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `kelurahan` (
  ...
  PRIMARY KEY (`id`),
  KEY `kelurahan_kec_id_foreign` (`kec_id`),
  CONSTRAINT `kelurahan_kec_id_foreign` FOREIGN KEY (`kec_id`) REFERENCES `kecamatan` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `koor` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `koor_user_id_foreign` (`user_id`),
  KEY `koor_kel_id_foreign` (`kel_id`),
  CONSTRAINT `koor_kel_id_foreign` FOREIGN KEY (`kel_id`) REFERENCES `kelurahan` (`id`),
  CONSTRAINT `koor_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pengumuman` (
  ...
  CONSTRAINT `pengumuman_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `saksi` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `saksi_user_id_foreign` (`user_id`),
  KEY `saksi_koor_id_foreign` (`koor_id`),
  KEY `saksi_partai_id_foreign` (`partai_id`),
  CONSTRAINT `saksi_koor_id_foreign` FOREIGN KEY (`koor_id`) REFERENCES `koor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `saksi_partai_id_foreign` FOREIGN KEY (`partai_id`) REFERENCES `partai` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `saksi_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `target` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `target_kab_id_foreign` (`kab_id`),
  CONSTRAINT `target_kab_id_foreign` FOREIGN KEY (`kab_id`) REFERENCES `kabupaten` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(21,	2,	'denpasarselatan',	'$2y$10$XbNI6tBqnueW7LGxQXMQqOaMiQo3ZAK1xJlZH.2QQAP7J7i5izjRm',	'nVazQtmFXIdEzrXsxzTbn3NOXokOUfxhGIoD3qQUmUOyTvSoh797GOnAKInL',	'2019-01-08 13:26:58',	'2019-02-12 11:58:14'),
...
(58,	1,	'pimpinan',	'$2y$10$w.d7LUIH9G9eCct6GQR74e/ya1mFXrAiUbpCPCu/UP80WRpW1C6by',	'VRARLajGz9stMalUS7TMx9bMvtMoV5wNlJl5Z1IvP74Q8wFnL4ICFzIglP3z',	'2019-01-08 13:26:58',	'2019-01-08 13:26:58'),
