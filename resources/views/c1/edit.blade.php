...
<head>
    ...
    <title>Edit Foto Formulir C1 - Sistem Informasi Manajemen Saksi Pemilu</title>
</head>
...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <form method="POST" action="{{route('c1.update', $c1->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <h3 class="text-center"><strong>Edit Foto Formulir C1</strong></h3>
        
            <label class="text-muted my-3" for="foto_c1">Foto Formulir C1</label>
            <div class="file-upload">
                <div class="image-upload-wrap" style="display:none;">
                    <input name="foto_c1" class="file-upload-input" type='file' onchange="readURL(this);" accept="image/*"/>
                    <div class="drag-text">
                        <h3><i class="mdi mdi-plus"></i></h3>
                    </div>
                </div>
                <div class="file-upload-content">
                    <a href="{{ asset("storage/c1/{$c1->foto_c1}") }}">
                        <img class="file-upload-image mb-1" src="{{ asset("storage/c1/{$c1->foto_c1}") }}" alt="your image" /><br>
                    </a>
                    <small class="image-title">{{$c1->foto_c1}}</small><br>
