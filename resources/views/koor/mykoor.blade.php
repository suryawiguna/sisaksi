...
<head>
    ...
    <title>Koordinator Saksi Saya - Sistem Informasi Manajemen Saksi Pemilu</title>
...
<div class="row">
    <div class="col-12">
        ...
        @endif
        <h3 class="text-center"><strong>Koordinator Saksi di Kecamatan Saya</strong></h3>
        <hr>
    </div>
</div>
...
<div class="row">
    <div class="col">
        <div class="table-responsive">
            <table id="tabelKoor" class="align-self-center table table-hover table-responsive table-bordered table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                ...
                },
                {
                    ...
                    return '<div class="dropdown">'+
                                ...
                                '<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">'+
                                    '<a class="dropdown-item py-2 text-btn" href="koor/'+data+'" title="Lihat Detail">Lihat Detail</a>'+
                                    '<a class="dropdown-item py-2 text-btn" href="koor/'+data+'/edit" title="Edit">Edit</a>'+
                                    '<a href="#" data-url="koor/'+data+'" class="dropdown-item text-danger text-btn py-2 btn-delete" title="Hapus" data-toggle="modal" data-target="#modalHapus">'+
                                        'Hapus'+
                                    '</a>'+
                                '</div>'+
                            '</div>';
